...
class DataModuleWithEdges(pl.LightningDataModule):
    def __init__(
        self,
        *,
        batch_size: int,
    ...
    def setup(self, stage: t.Optional[str] = None) -> None:
        ...
        self.validation_dataset = dl.CelebAFaceAutoencoderDatasetWithEdges(
            dataset_root=os.path.join(self.dataset_root, "val"),
            preprocess_pipeline=preprocessing_pipeline,
        )

        self.test_dataset = dl.CelebAFaceAutoencoderDatasetWithEdges(
            dataset_root=os.path.join(self.dataset_root, "test"),
            preprocess_pipeline=preprocessing_pipeline,
        )
...
class TrainingModuleWithEdges(pl.LightningModule):
    def __init__(
        self,
        *,
        lr: float,
        ...
        self.learning_rate = lr
        self.criterion = losses.VanillaVAELossWithEdges(
            recon_loss_weight, kld_loss_weight
        )
